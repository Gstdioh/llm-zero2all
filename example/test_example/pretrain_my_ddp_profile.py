...
OMP_NUM_THREADS=8 NCCL_P2P_DISABLE=1 torchrun --standalone --nproc_per_node=4 pretrain_my_ddp_profile.py --batch_size=16 --gradient_accumulation_steps=12
...
from dataset_legacy import Task
