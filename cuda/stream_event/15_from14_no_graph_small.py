...
#         static_loss = loss_fn(static_output, static_target) / gradient_accumulation_steps
...
with torch.profiler.profile(
    ...
    schedule=torch.profiler.schedule(
        ...
        active=6,
        repeat=1),
    on_trace_ready=torch.profiler.tensorboard_trace_handler('../../res_profile/test_graph/15_from14_no_graph_small', worker_name=f'rank{ddp_rank}'),
    record_shapes=True,
