...
with torch.profiler.profile(
    ...
    schedule=torch.profiler.schedule(
        ...
        active=6,
        repeat=1),
    on_trace_ready=torch.profiler.tensorboard_trace_handler('../../res_profile/test_graph/12_Power_SGD_no_block_stream_event_graph_queue1', worker_name=f'rank{ddp_rank}'),
    record_shapes=True,
