...
def test_hook(
    ...
    fut.set_result(torch.zeros_like(input_tensor, device=tensor.device))
...
with torch.profiler.profile(
    ...
    schedule=torch.profiler.schedule(
        ...
        active=6,
        repeat=1),
    on_trace_ready=torch.profiler.tensorboard_trace_handler('../../res_profile/test_graph/09_Power_SGD_no_block_stream_event', worker_name=f'rank{ddp_rank}'),
    record_shapes=True,
